...
var $W = $(window),
  ...
  defaults = {
    ...
    icons: {
      ...
      actualSize: 'fa fa-arrows-angle-contract',
      rotateLeft: 'fa fa-arrow-counterclockwise',
      rotateRight: 'fa fa-arrow-clockwise',
      loading: 'fa fa-spinner fa-arrow-clockwise'
    },
    // lang: 'en',
    i18n: {
      maximize: 'maximize',
...
Magnify.prototype = {
  ...
  zoomTo: function (ratio, origin, e) {
    ...
    var Î´ = !this.isRotated ? 0 : (newWidth - newHeight) / 2,
...
var movable = function (stage, image) {
  ...
  var dragStart = function (e) {
    ...
    Î´ = !self.isRotated ? 0 : (imageWidth - imageHeight) / 2;
...
var resizable = function (modal, stage, image, minWidth, minHeight) {
  ...
  var getImageOpts = function (dir, offsetX, offsetY) {
    ...
    var widthDiff = (offsetX + modalData.w) > minWidth ? (stageData.w - imgWidth + offsetX - Î´) : (minWidth - (modalData.w - stageData.w) - imgWidth - Î´),
      heightDiff = (offsetY + modalData.h) > minHeight ? (stageData.h - imgHeight + offsetY + Î´) : (minHeight - (modalData.h - stageData.h) - imgHeight + Î´),

      widthDiff2 = (-offsetX + modalData.w) > minWidth ? (stageData.w - imgWidth - offsetX - Î´) : (minWidth - (modalData.w - stageData.w) - imgWidth - Î´),
      heightDiff2 = (-offsetY + modalData.h) > minHeight ? (stageData.h - imgHeight - offsetY + Î´) : (minHeight - (modalData.h - stageData.h) - imgHeight + Î´);

    // Get image position in dragging
    var imgLeft = $(image).position().left - Î´,
      imgTop = $(image).position().top + Î´;
    ...
    var opts = {
      ...
      'w': {
        left: widthDiff2 >= -Î´ ? ((widthDiff2 - Î´) / 2 + 'px') : (imgLeft > widthDiff2 ? (imgLeft + 'px') : (widthDiff2 + 'px'))
      },
      'n': {
        top: heightDiff2 >= Î´ ? ((heightDiff2 + Î´) / 2 + 'px') : (imgTop > heightDiff2 ? (imgTop + 'px') : (heightDiff2 + 'px'))
      },
      'nw': {
        top: heightDiff2 >= Î´ ? ((heightDiff2 + Î´) / 2 + 'px') : (imgTop > heightDiff2 ? (imgTop + 'px') : (heightDiff2 + 'px')),
        left: widthDiff2 >= -Î´ ? ((widthDiff2 - Î´) / 2 + 'px') : (imgLeft > widthDiff2 ? (imgLeft + 'px') : (widthDiff2 + 'px'))
  ...
  var dragStart = function (dir, e) {
    ...
    // Î´ is the difference between image width and height
    Î´ = !self.isRotated ? 0 : (imageData.w - imageData.h) / 2;
